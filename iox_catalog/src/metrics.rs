...
decorate!(
    ...
    methods = [
        "namespace_create" = create(&mut self, name: &str, partition_template: Option<&proto::PartitionTemplate>, retention_period_ns: Option<i64>) -> Result<Namespace>;
...
decorate!(
    ...
    methods = [
        "table_create" = create(&mut self, name: &str, partition_template: Option<&proto::PartitionTemplate>, namespace_id: NamespaceId) -> Result<Table>;
