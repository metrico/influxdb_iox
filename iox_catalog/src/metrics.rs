...
use data_types::{
    Column, ColumnType, CompactionLevel, Namespace, NamespaceId,
...
decorate!(
    ...
    methods = [
        "namespace_create" = create(&mut self, name: &str, partition_template: &NamespacePartitionTemplateOverride, retention_period_ns: Option<i64>) -> Result<Namespace>;
