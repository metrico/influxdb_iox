...
mod tests {
    ...
    async fn test_query() {
        ...
        - "| physical_plan    | ParquetExec: limit=None, partitions={1 group: [[1/1/1/1/1/00000000-0000-0000-0000-000000000000.parquet, 1/1/1/1/3/00000000-0000-0000-0000-000000000001.parquet, 1/1/1/1/1/00000000-0000-0000-0000-000000000002.parquet, 1/1/1/1/1/00000000-0000-0000-0000-000000000003.parquet, 1/1/1/1/2/00000000-0000-0000-0000-000000000004.parquet]]}, projection=[foo, host, load, time]    |"
        - "|    |    |"
        - "----------"
        "###
        );
        ...
        - "|    |   ParquetExec: limit=None, partitions={1 group: [[1/1/1/1/4/00000000-0000-0000-0000-000000000000.parquet]]}, output_ordering=[host@0 ASC, time@2 ASC], projection=[host, perc, time]    |"
        - "|    |    |"
        - "----------"
        "###
        );
        ...
        - "|    |   ParquetExec: limit=None, partitions={1 group: [[1/1/1/1/1/00000000-0000-0000-0000-000000000000.parquet, 1/1/1/1/3/00000000-0000-0000-0000-000000000001.parquet, 1/1/1/1/1/00000000-0000-0000-0000-000000000002.parquet, 1/1/1/1/1/00000000-0000-0000-0000-000000000003.parquet]]}, projection=[foo, host, load, time]    |"
        ...
        - "|    |         ParquetExec: limit=None, partitions={2 groups: [[1/1/1/1/2/00000000-0000-0000-0000-000000000004.parquet], [1/1/1/1/2/00000000-0000-0000-0000-000000000005.parquet]]}, output_ordering=[host@2 ASC, time@4 ASC, __chunk_order@0 ASC], projection=[__chunk_order, foo, host, load, time]    |"
        - "|    |    |"
        - "----------"
        "###
        );
