...
async fn two_giant_files() {
    ...
    - "SKIPPED COMPACTION for PartitionId(1): partition 1 has overlapped files that exceed max compact size limit 314572800, and cannot be split because they cover a single ns of time 100."
    - "**** Final Output Files (0b written)"
    - "L0, all files 4.88gb                                                                                               "
    - "L0.1[100,100] 1ns        |------------------------------------------L0.1------------------------------------------|"
    - "L0.2[100,100] 2ns        |------------------------------------------L0.2------------------------------------------|"
